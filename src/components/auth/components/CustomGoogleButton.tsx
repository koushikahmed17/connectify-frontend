...
const CustomGoogleButton: React.FC<CustomGoogleButtonProps> = ({
  ...
  return (
    <button
      ...
      className={`w-full py-3 px-4 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors flex items-center justify-center ${
    ...
    >
      {isButtonLoading ? (
        <div className="flex items-center">
          ...
          {isGoogleLoading ? "Connecting..." : "Loading..."}
        </div>
      ) : (
        <>
